...
public class UpdateActivity extends AppCompatActivity {
    ...
    public void prosesSubmit(View view) {
        ...
        call.enqueue(new Callback<Data<Profile>>() {
            ...
            public void onFailure(Call<Data<Profile>> call, Throwable t) {
                Toast.makeText(UpdateActivity.this, "Gagal edit profile", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    //    Toast.makeText(UpdateActivity.this, "", Toast.LENGTH_SHORT).show();
        Intent intent=new Intent(UpdateActivity.this, PasswordUpdateActivity.class);
