...
public class PasswordUpdateActivity extends AppCompatActivity {
    ...
    public void prosesSubmit(View view) {
        ...
        Call<Data<Profile>> call = service.editPassword(token_type+""+token, new UpdatePasswordRequest(pass.getText().toString(), conf.getText().toString()));
        call.enqueue(new Callback<Data<Profile>>() {
            ...
            public void onResponse(Call<Data<Profile>> call, Response<Data<Profile>> response) {
                if (pass.getText().toString().length()<8 || pass.getText().toString().isEmpty()){
                    ...
                    if (response.body()!=null){
                        Toast.makeText(PasswordUpdateActivity.this, "Change password success", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onFailure(Call<Data<Profile>> call, Throwable t) {
                Toast.makeText(PasswordUpdateActivity.this, "Gagal change password", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void kembali(View view) {
        Intent intent=new Intent(PasswordUpdateActivity.this, UpdateActivity.class);
